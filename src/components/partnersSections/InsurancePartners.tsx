...
import wartaZycie from "@/assets/images/warta_zycie.png";
...
const insuranceCompanies: InsuranceCompaniesType[] = [
  ...
  { name: "Warta", logo: warta },
  { name: "Warta Życie", logo: wartaZycie },
  { name: "Warta HDI", logo: wartaHDI },
  { name: "ERGO Hestia", logo: hestia },
  { name: "mtu24.pl", logo: mtu24 },
