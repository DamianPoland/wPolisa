    ...
    <section className="relative overflow-hidden bg-gradient-hero px-4 md:px-2">
      ...
      <div className="container relative pt-20 pb-22 md:pb-28 lg:pb-40 xl:pb-46 m-auto">
        <div className="mx-auto max-w-4xl text-center">
          ...
          {/* Benefits */}
          <div className="animate-slide-up mt-8 flex flex-wrap items-center justify-center gap-4 md:gap-6">
          ...
          {/* Trust Badge */}
          <p className="animate-fade-in mt-12 text-lg text-primary-foreground/80">
      ...
      <div className="absolute bottom-0 left-0 right-0 leading-0">
        <svg viewBox="0 0 1440 124" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full block -mb-px">
          <path
