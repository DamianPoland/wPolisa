    ...
    <div className="flex flex-col items-center  min-h-screen p-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div
          ...
          className="group relative w-full aspect-square bg-gradient-to-br from-purple-500 to-purple-600 rounded-lg shadow-lg cursor-pointer overflow-hidden transition-all duration-300 hover:shadow-2xl hover:scale-102 active:scale-95"
        >
          {/* Background Animation */}
          <div className="absolute inset-0 bg-gradient-to-tr from-purple-400 to-purple-700 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
